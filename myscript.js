      ...
      datasets: [
        ...
        },
        {
            label: "Mindful Moments",
             fill: false,
            backgroundColor: ["rgba(255,140,0)","rgba(255,140,0)","rgba(255,140,0)","rgba(255,140,0)","rgba(255,140,0)","rgba(255,140,0)","rgba(255,140,0)","rgba(255,140,0)","rgba(255,140,0)","rgba(255,140,0)","rgba(255,140,0)","rgba(255,140,0)"],
            borderWidth: 2,
        ...
        },
        {
            label: "Food Drive",
             fill: false,
            backgroundColor: ["rgba(221,160,221)","rgba(221,160,221)","rgba(221,160,221)","rgba(221,160,221)","rgba(221,160,221)","rgba(221,160,221)","rgba(221,160,221)","rgba(221,160,221)","rgba(221,160,221)","rgba(221,160,221)","rgba(221,160,221)","rgba(221,160,221)"],
            borderWidth: 2,
